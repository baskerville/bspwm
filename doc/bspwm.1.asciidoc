...
'pointer_action2'::
'pointer_action3'::
	Action performed when pressing 'pointer_modifier<n>' + 'button<n>'. Accept the following values: *move*, *resize_side*, *resize_corner*, *focus*, *none*.
...
'pointer_modifier1' + 'button1'::
	Move the window under the pointer.

'pointer_modifier2' + 'button2'::
	Resize the window under the pointer by dragging the nearest side.

'pointer_modifier3' + 'button3'::
	Resize the window under the pointer by dragging the nearest corner.

The behavior of 'pointer_modifier<n>' + 'button<n>' can be modified through the 'pointer_action<n>' setting.
